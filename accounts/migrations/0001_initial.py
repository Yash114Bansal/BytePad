    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_semester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.semester')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_number', models.BigIntegerField()),
                ('date_of_birth', models.DateField()),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.branch')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
