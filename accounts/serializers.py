...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserProfile
        fields = ['id', 'email', 'password', 'is_department_head', 'is_faculty', 'is_student']
...
class StudentSerializer(serializers.ModelSerializer):
    class Meta:
        model = StudentModel
        fields = ['id', 'roll_number', 'current_semester', 'branch', 'contact_number', 'date_of_birth', 'guardian_name', 'guardian_contact_number']

class FacultySerializer(serializers.ModelSerializer):
    class Meta:
        model = FacultyModel
        fields = ['id', 'contact_number', 'date_of_birth', 'courses', 'department', 'is_department_head']
